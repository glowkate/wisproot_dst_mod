...
return {
	...
	DESCRIBE =
	{
		...
		TRINKET_2 = "Er...what do I do with this?", --Fake Kazoo
		TRINKET_3 = "The knot is stuck. Forever.", --Gord's Knot
		TRINKET_4 = "It must be some kind of religious artifact.", --Gnome
		TRINKET_5 = "Could we go higher?", --Toy Rocketship
		TRINKET_6 = "Do I eat this?", --Frazzled Wires
		TRINKET_7 = "There's no time for fun and games!", --Ball and Cup
		TRINKET_8 = "What even is this thing?", --Rubber Bung
		TRINKET_9 = "What should I do with these?", --Mismatched Buttons
		TRINKET_10 = "They've quickly become Wes' favorite prop.", --Dentures
		TRINKET_11 = "They call it He-ah-el", --Lying Robot
		TRINKET_12 = "Ew.", --Dessicated Tentacle
		...
		TRINKET_17 = "I'd put it in my fur if I had any.", --Bent Spork
		TRINKET_18 = "I wonder what it's hiding?", --Trojan Horse
		TRINKET_19 = "Oooh, fun!", --Unbalanced Top
		TRINKET_20 = "For itching at fur.", --Backscratcher
		TRINKET_21 = "Cracking the egg wasn't enough I see.", --Egg Beater
		TRINKET_22 = "Could I weave it into something?", --Frayed Yarn
		TRINKET_23 = "I can put my shoes on without help, thanks.", --Shoehorn
		TRINKET_24 = "It's like a catcoon but without the coon.", --Lucky Cat Jar
		TRINKET_25 = "It smells kind of stale.", --Air Unfreshener
		TRINKET_26 = "Food in a cup! The ultimate survival container.", --Potato Cup
		TRINKET_27 = "If you unwound it you could poke someone from far away.", --Coat Hanger
        ...
        TRINKET_35 = "Go on. Drink.", --Empty Elixir
        TRINKET_36 = "Hah, teeth. Cute.", --Faux fangs
        TRINKET_37 = "Chunk of broken wood.", --Broken Stake
        TRINKET_38 = "Looks grifty.", -- Binoculars Griftlands trinket
        TRINKET_39 = "It needs a friend.", -- Lone Glove Griftlands trinket
        TRINKET_40 = "Holding it makes me feel like bartering.", -- Snail Scale Griftlands trinket
        TRINKET_41 = "I don't like how hot it is.", -- Goop Canister Hot Lava trinket
        TRINKET_42 = "Do they have these cross the ocean??", -- Toy Cobra Hot Lava trinket
        ...
        TRINKET_46 = "Looks like the stuff mom colects.", -- Hairdryer ONI trinket
        ...
        HALLOWEENCANDY_9 = "Sticks to your mouth.",
		...
		MADSCIENCE_LAB = "Do I have to?",
		LIVINGTREE_ROOT = "Something's in there! I'll have to root it out.", 
		LIVINGTREE_SAPLING = "It'll grow up big and strong!",

        DRAGONHEADHAT = "I am the flames!",
        DRAGONBODYHAT = "Underated in my opinion.",
        DRAGONTAILHAT = "Shiny!",
        PERDSHRINE =
        {
		...
		TRUNKVEST_SUMMER = "I'd rather have just eaten it.",
		TRUNKVEST_WINTER = "Too puffy to wear with a backpack.",
		TRUNK_COOKED = "Not my first choice but I'll take it.",
		TRUNK_SUMMER = "It's full of snot.",
		TRUNK_WINTER = "Its built to resist the cold.",
		TUMBLEWEED = "It's like a little loot basket.",
		TURKEYDINNER = "It's still got the bones in it.",
		TWIGS = "A handful of twigs!",
		UMBRELLA = "Helps prevent my bark from rotting.",
		GRASS_UMBRELLA = "On the bright side, it's vegan.",
		UNIMPLEMENTED = "This looks dangerous! I want to touch it!",
		WAFFLES = "Volt goat milk never makes good butter.",
		WALL_HAY = 
		{	
			GENERIC = "I'd love to sleep in it.",
			BURNT = "Guess we should have used stone.",
		},
		WALL_HAY_ITEM = "Could we use it as a bed instead?",
		WALL_STONE = "Looks quite nice, does it not?",
		WALL_STONE_ITEM = "Such fine craftmenship.",
		WALL_RUINS = "It's a lump of wall.",
		WALL_RUINS_ITEM = "Heavy...",
		WALL_WOOD = 
		{
			GENERIC = "It would make quite a nice bonfire.",
			BURNT = "Haha! That's what you get!",
		},
		WALL_WOOD_ITEM = "It can't even move. How lame.",
		WALL_MOONROCK = "I feel like it's going to turn on me.",
		WALL_MOONROCK_ITEM = "It burns my hands.",
		FENCE = "It looks quite nice.",
        FENCE_ITEM = "Hmm, where could I put this?",
        FENCE_GATE = "For comming in and out of things.",
        FENCE_GATE_ITEM = ".",
